        ...
        <main className="landing">
          ...
          <div className="features">
            <div>
              ...
              <span>Questions adjust to your performance</span>
            </div>

            <div>
              <strong>Technical</strong>
              <span>Focused on real-world technical skills</span>
            </div>

            <div>
              <strong>AI Evaluated</strong>
              <span>Get detailed feedback on your answers</span>
            </div>
          </div>
        </main>
      </div>
        ...
        <main className="landing">
          <div className="feedback-card">
            ...
            {feedback ? (
              ...
              <p>Final feedback is unavailable.</p>
            )}
        ...
        <div className="interview-card">
          ...
          {evaluation && (
            <div className="evaluation">
              <h3>Previous Answer Evaluation</h3>

              <p>
                <strong>Score:</strong> {evaluation.score}/5
              </p>

              <p>
                <strong>Depth:</strong> {evaluation.depth}
              </p>
            </div>
          )}
